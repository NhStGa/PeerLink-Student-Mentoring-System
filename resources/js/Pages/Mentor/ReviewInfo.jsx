                ...
                <Paper sx={{ p: { xs: 3, md: 5 }, borderRadius: 3, boxShadow: 3 }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, p: 3, bgcolor: '#f8fafc', borderRadius: 2, border: '1px solid #e2e8f0', mb: 4 }}>
                        <Avatar 
                            ...
                            sx={{ width: 72, height: 72, bgcolor: 'secondary.main', fontSize: '2rem' }}
                            >
                        ...
                        <Box>
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', mt: 0.5 }}>
                                ...
                                {review.student?.student_profile?.program?.name || 'Student Program'}
                            </Typography>
                    ...
                    <Box sx={{ mb: 4 }}>
                        ...
                        <Paper variant="outlined" sx={{ p: 3, bgcolor: '#fafafa', borderRadius: 2 }}>
                            <Typography variant="body1" sx={{ whiteSpace: 'pre-wrap', lineHeight: 1.7 }}>
                                {review.review_text || <span style={{ fontStyle: 'italic', color: 'gray' }}>The student did not leave a written comment.</span>}
                            </Typography>
                        </Paper>
                    </Box>
                    ...
                    <Typography variant="h5" fontWeight="bold" color="primary.main" sx={{ mb: 3 }}>
                        Past Sessions with {review.student?.fname}
                    </Typography>
