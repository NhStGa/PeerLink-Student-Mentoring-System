            ...
            <Container maxWidth="xl" sx={{ pt: 0, pb: 4, height: 'calc(100vh - 64px)', display: 'flex', flexDirection: 'column' }}>
                ...
                <Box sx={{ mb: 4 }}>
                    ...
                    <Typography variant="body1" color="text.secondary">
                        View and manage your entire session history.
                    </Typography>
                </Box>
                                            ...
                                            <ListItem disablePadding>
                                                ...
                                                >
                                                    ...
                                                    <Typography variant="caption" color="text.secondary" sx={{ display: 'flex', alignItems: 'center', gap: 0.5, mt: 0.25 }}>
                                                        Mentor: {session.mentor?.fname} {session.mentor?.lname}
                                                    </Typography>
                                                </ListItemButton>
                                            </ListItem>
                                            <Divider />
                    ...
                    <Grid size={{ xs: 12, md: 8, lg: 9 }} sx={{ height: '100%' }}>
                        <Paper sx={{ height: '100%', borderRadius: 3, boxShadow: 3, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
                            {selectedSession ? (
                                <>
                                    ...
                                    <Box sx={{ p: 4, bgcolor: '#f8fafc', borderBottom: 1, borderColor: 'divider', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                                        <Box>
                                            ...
                                            {/* FIXED: Added !! to convert the 0/1 to a pure boolean, stopping the random "0" from printing! */}
                                            {!!selectedSession.is_custom && (
                                                <Chip label="Off-Schedule Request" size="small" color="info" variant="outlined" sx={{ fontWeight: 'bold', ml: 1 }} />
                                            )}
                                        </Box>

                                        {/* FIXED: Converted this entirely to a ternary operator (? true : null) to prevent boolean 0 rendering at the far right! */}
                                            ...
                                            <Grid container spacing={3}>
                                                ...
                                                <Grid size={{ xs: 12, sm: 6 }}>
                                                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                                        ...
                                                        <Box>
                                                            <Typography variant="caption" color="text.secondary" display="block" textTransform="uppercase" fontWeight="bold">Mentor</Typography>
                                                            <Typography variant="body1" fontWeight="bold">{selectedSession.mentor?.fname} {selectedSession.mentor?.lname}</Typography>
                                                        </Box>
                                                    </Box>
                                                </Grid>
                                ...
                                /* Empty State when no session is selected or list is empty */
